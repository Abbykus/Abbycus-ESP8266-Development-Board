...
This project example demonstrates how to create a peer-to-peer wireless serial UART bridge between any combination of Windows PC's, MAC's, laptops, Raspberry Pi's, etc.
...
- Compile and download the code to two QDEV-ESP8266 devices and install each one in a USB-A socket.
...
### APPLICATION IDEAS
- Wireless control of CNC / 3D printers.
- Remotely control any device that uses Serial communications.
- Could be modified to bridge other busses. Example UART <-> I2C, UART <-> SPI, UART <-> CAN, etc.
